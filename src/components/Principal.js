    ...
    <Fragment>
      ...
      <section className="my-5 row container">
        <div className="bg-primary text-light py-3 my-3 rounded col-sm-12">
          <h3 className="ms-4" value='deportes'>Deportes</h3>
        </div>
        <div className='row'>
          {
            props.productos.map((producto)=>(producto.categoria === 'deportes')?(<CategoriaPcpal producto={producto} key={producto.id}></CategoriaPcpal>):(null))
          }
        </div>
